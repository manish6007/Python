    ...
    body: [
      ...
      ['Import instead of typing',
        ['Upload a broker export exactly as it downloads — Zerodha, Groww, Upstox, Angel One, ICICI Direct and most others, CSV or XLSX. No need to rename columns.',
          ...
          'A CAMS/KFintech consolidated account statement PDF brings in every mutual-fund folio across both registrars at once — you need the password you chose when requesting it.',
